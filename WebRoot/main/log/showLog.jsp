...
//           } ] 
      ...
      $.ajax({
	  	   ...
	  	   success: function(data){
	  		   ...
	  		   $('#logSceneBox').combobox("loadData", data.message);
	  	   }                                                                                         
	  	});
      ...
      $('#logSceneBox').combobox({
		  onSelect: function (n,o) {
			  var sceneId =  $('#logSceneBox').combobox('getValue');
			  $.ajax({
		    	   type: "POST",
     ...
     $('#search').click(function() {
    	 $('#logGrid').datagrid('load',{
    		 'logPage.sceneId' : $('#logSceneBox').combobox('getValue'),
...
// 	}
	...
	<table border="1px solid">
		<tr>
			...
			<td>
				<select id="logSceneBox" class="easyui-combobox" name="logPage.sceneId" style="width:130px;" data-options="valueField:'id', textField:'sceneName', panelHeight:'auto'">
